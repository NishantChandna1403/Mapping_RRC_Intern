...
#define NODE_MAIN_LOGGER_NAME "odometry_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libodometry_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<genz_icp_ros::OdometryServer>";
